...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2021 at 09:01 PM
...
INSERT INTO `account` (`userID`, `username`, `email`, `password`, `createdAt`)
VALUES (1, ''davidilchmann'', ''david.ilchmann@gmail.com'', ''$2y$10$d7ajFCIz.fnS9VY4AcEfoeEK/lqm8HAzEu4LKWbP0ZsGuLgC44Wsq'', ''0000-00-00''),
...
INSERT INTO `appointment` (`id`, `userID`, `treatmentID`, `roomID`, `start`, `end`, `status`)
VALUES (2, 1, 1, 1, ''2020-12-28 16:00:00'', ''2020-12-28 16:30:00'', ''completed''),
...
INSERT INTO `appointment_admin` (`appointmentID`, `adminID`)
VALUES (2, 9),
       (2, 10),
       (3, 9),
       (4, 7),
...
INSERT INTO `appointment_typical` (`id`, `treatment`, `day`, `endTime`, `startTime`)
VALUES (5, 2, ''Montag'', ''15:00:00'', ''12:00:00''),
...
INSERT INTO `notapproved` (`id`, `userID`, `code`, `datetime`)
VALUES (1, 1, ''a00ecfa70e895fda7a5404b18d07f495a29468bbb17763ad37'', ''0000-00-00 00:00:00''),
...
INSERT INTO `opening_times` (`id`, `day`, `opening`, `closing`)
VALUES (1, ''Montag'', ''09:00:00'', ''12:00:00''),
...
INSERT INTO `passwordreset` (`id`, `userID`, `code`, `datetime`, `isUsed`)
VALUES (1, 13, ''a5202c5184df220a5c68e74aa0ebddd454abd429215f4485e4'', ''2021-06-22 14:40:03'', 0);
...
INSERT INTO `session` (`id`, `userID`, `token`, `start`, `end`, `ip`)
VALUES (1, 1, ''13c45e794fbc49093bd8d01c9ffbb77c0e8d2285c45cc9f02b'', ''0000-00-00 00:00:00'', NULL, NULL),
...
INSERT INTO `treatment` (`id`, `name`, `duration`, `nrDoctors`, `nrNurses`)
VALUES (1, ''Vorsorgeuntersuchung'', 30, 1, 1),
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `salutation`, `insurance`, `birthday`, `patientID`)
VALUES (1, ''David'', ''Ilchmann'', ''Herr'', ''gesetzlich'', ''0000-00-00'', ''''),
